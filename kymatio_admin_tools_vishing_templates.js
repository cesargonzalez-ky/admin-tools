(function () {
  ...
  var MODULE_VERSION = 'vishing-04-version-banner';
  ...
  function renderGui(container, tools) {
    ...
    function shell(){ return '<div style="background:#fff7ed;border:2px solid #fb923c;border-radius:10px;padding:12px 14px;margin-bottom:12px;color:#9a3412"><div style="display:flex;justify-content:space-between;gap:8px;align-items:flex-start"><div style="font-size:22px;font-weight:900">BORRADOR</div><div style="font-size:11px;font-weight:800;background:#fed7aa;color:#9a3412;border:1px solid #fdba74;border-radius:999px;padding:3px 8px;white-space:nowrap">' + h(MODULE_VERSION) + '</div></div><div style="font-size:12px;margin-top:2px">Módulo inicial en pruebas. No usar como definitivo hasta validación.</div></div>'; }
