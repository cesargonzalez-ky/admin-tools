(function () {
  ...
  async function loadCompanyData(force) {
    ...
    var url =
      'https://api-dev.kymatio.xyz/v2/admin/stakeholders/companies/' +
  ...
  async function putCompanyPayload(payload) {
    ...
    var res = await fetch('https://api-dev.kymatio.xyz/v2/admin/stakeholders/companies/' + encodeURIComponent(state.companyId), {
      method: 'PUT',
      headers: apiHeaders(),
